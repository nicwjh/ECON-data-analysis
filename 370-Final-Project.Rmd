...
############# 1 - Drop observations with missing prvdr_num ############# 
hcris_data <- hcris_data[complete.cases(hcris_data$prvdr_num), ]

############# 2 - Take absolute value for cost variables #############
...
############# 3 - Replace NAs with 0 for epo_rebates #############
hcris_data$epo_rebates[is.na(hcris_data$epo_rebates)] = 0

############# 4 - Clean epo variables #############
##### 4a - epo_cost #####
...
############# 5 - Switch epo_cost and epo_net_cost for relevant observations #############
hcris_data <- hcris_data %>%
