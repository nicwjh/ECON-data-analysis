...
# Default - chain_indicator == 0 
hcris_data$chain_id = 0

# indicator == NA f

for (i in 1:nrow(hcris_data)){
  if (is.na(hcris_data$chain_indicator)){ # indicator NA
    hcris_data$chain_id = NA
  }
  else if (hcris_data$is_fresenius[i]){ # Fresenius chain
...
<<<<<<< HEAD
1. Jack - If large chains have lower average cost
Tracking as individual providers change from independent to chain - any variables change? 
2. Drug dosage with independent to chain 
3. Sophia - Missing variables + Regression
3. 
=======
8. Main concerns: parts 9 - 12 of cleaning 
>>>>>>> 0efaec978629dd7aa0d9a95a9cb1834397c1258e
