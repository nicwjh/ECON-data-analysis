...
## Question: why are the datasets (nmrc and alpha) identical? 

# trying to parse through the dataframe to check for a variable_code match 
toMatch = paste(variable_codes$key, collapse = "|")
result = filter(nmrc1999, grepl(toMatch, key))
grepl("[variable_codes$key]", nmrc1998$key)
