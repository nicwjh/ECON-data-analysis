...
hcris_data["prvdr_num"][hcris_data["prvdr_num"] == 322664] <- 342664
...
hcris_data = mutate(hcris_data, report_end_date = mdy(report_end_date))
  ...
  # pretty sure it's correct, but in alex's directions it says i should have gotten a warning for report_start_data, and i didn't get one soo 
