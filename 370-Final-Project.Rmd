...
Check with group: combine analysis into one large block of text, or keep it separated? 
Ask Ellis if she was directly quoting on some parts
if someone wants to find support for the data reporting stuff that also could beneficial
...
```
Check with group: wording on why the additional variables are included. 
...
```
# Analysis
Check with group: little bit more analysis for the box plot?
